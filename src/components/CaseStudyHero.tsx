...
export function CaseStudyHero({
    ...
    image = "/images/case-study-banner.webp"
}: CaseStudyHeroProps) {
    return (
        <section className="bg-[#FFF2EB] pt-16 sm:pt-24 md:pt-32 lg:pt-48 pb-12 sm:pb-16 md:pb-20 lg:pb-32 relative overflow-hidden">
            <div className="container mx-auto px-4 sm:px-6 text-center">
                ...
                {/* Badge */}
                <div className="inline-flex items-center gap-2 mb-6 sm:mb-8 px-3 sm:px-4 py-1.5 rounded-full">
                ...
                <div className="relative max-w-6xl mx-auto">
                    <div className="relative rounded-lg sm:rounded-xl lg:rounded-2xl overflow-hidden aspect-[16/9] lg:aspect-[2/1] shadow-2xl border-4 border-white">
